    ...
    <div class="container">
        ...
        if (isset($_POST['add'])) {
            ...
            if (!empty($name) && !empty($price) && !empty($image)) {
                ...
                try{
                $pdo = new PDO('mysql:host=localhost;port=8889;dbname=master_theweb', 'root', 'root', [PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION]);
            } catch (Exception $e) {
                die($e->getMessage());
            }
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <input type="number" step="0.01" class="form-control custom" name="price" min="1">
